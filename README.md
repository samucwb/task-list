...
To build the final jar and optimize the tasklist application for production, run:
...
Then navigate to [http://localhost:60590](http://localhost:60590) in your browser.
